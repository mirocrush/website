    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12" style={{ background: 'transparent' }}>
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-extrabold tracking-tight" style={{ color: '#bbf7d0' }}>Create your account</h1>
          <p className="text-sm mt-1" style={{ color: 'rgba(134,239,172,0.55)' }}>Get started for free</p>
        </div>
